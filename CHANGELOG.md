...
- Fixed fullscreen under fractional WSLg display scaling so the window reaches the screen edges, pointer hit targets stay aligned, and the prior small-window bounds restore; the responsive layout remains usable down to 720×520.
