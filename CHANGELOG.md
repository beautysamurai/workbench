...
- Malformed PNG image-data streams, lossy WebP frame tags, and incomplete lossless WebP streams are rejected, and duplicate task IDs no longer expose a Send to Codex action that could select the wrong task.
